...
const handler = async (req: Request) => {
  console.log("🚀 NEW V2 activation email handler");
  ...
  try {
    ...
    console.log("📧 Using NEW V2 template for:", email);
    ...
    console.log("✅ NEW V2 activation email sent successfully:", data);
    ...
    console.error("Error in send-activation-email-v2 function:", error);
    return new Response(
