        ...
        <Card className={`${isMobile ? '' : 'lg:col-span-1'} bg-white dark:bg-[#1c1c1e] dark:border dark:border-[#232325] rounded-2xl`}>
          ...
          <CardContent className="p-0">
            <ScrollArea className={`${isMobile ? 'h-[400px]' : 'h-[500px]'}`}>
              {conversations.map(conversation => <div key={conversation.id} className={`p-4 border-b cursor-pointer hover:bg-[#f0f0f0] dark:hover:bg-[#232324] ${activeConversationId === conversation.id ? 'bg-[#f0f0f0] dark:bg-[#232324]' : ''}`} onClick={() => handleConversationSelect(conversation.id)}>
