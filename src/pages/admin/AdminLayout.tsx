        ...
        <div className="flex">
          ...
          <div className={cn(
            ...
            <div className="px-8 py-6 flex items-center gap-3">
              <AuthLogo className="relative h-8 -translate-y-[1px]" />
              <Badge variant="secondary" className="bg-badge-subscription-bg dark:bg-badge-subscription-bg-dark text-badge-subscription-text hover:bg-badge-subscription-bg dark:hover:bg-badge-subscription-bg-dark py-1 -translate-y-[1px]">
                Admin
              </Badge>
            </div>
