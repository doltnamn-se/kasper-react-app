          ...
          <div className="flex flex-col space-y-4">
            <div className="flex flex-col-reverse md:flex-row justify-between md:items-end w-full gap-4 md:gap-0">
              <TabsList className="relative w-full md:w-auto overflow-hidden">
                <div
                  className={`pointer-events-none absolute top-1 bottom-1 left-1 rounded-[12px] bg-[#d4f5b6] w-[calc(50%-0.25rem)] transition-transform duration-300 ease-out will-change-transform ${activeTab === 'incoming' ? 'translate-x-0' : 'translate-x-full'}`}
                  aria-hidden
                />
          ...
          <TabsContent value="incoming" className="mt-6">
            <div className="bg-white dark:bg-[#1c1c1e] p-6 rounded-2xl shadow-sm border border-[#e5e7eb] dark:border-[#232325] transition-colors duration-200">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div className="bg-[#121212] text-white dark:bg-white dark:text-[#121212] w-6 h-6 md:w-7 md:h-7 rounded-full flex items-center justify-center text-xs font-medium" style={{ paddingRight: '1px' }}>
