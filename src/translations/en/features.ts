...
const features: FeaturesTranslations = {
  ...
  'guide.completion.message': 'Please complete the guide for {site} to hide your information',
  ...
  'deindexing.status.notification.message': 'The status of a link removal request has been updated'
};
