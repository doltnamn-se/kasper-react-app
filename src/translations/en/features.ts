...
export const features: FeaturesTranslations = {
  ...
  'step.4.description': 'Share your address or social security number with us so we can ensure we\'re looking at the right person online when hiding your details',
