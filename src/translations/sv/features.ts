...
const features: FeaturesTranslations = {
  ...
  'guide.eniro.step1': 'Gå till länken ovan',
  'guide.eniro.step2': 'Klicka på "Ändra eller ta bort uppgifter"',
  'guide.eniro.step3': 'Fyll i dina uppgifter och klicka på "Skicka"',
  'guide.mrkoll.title': 'Mrkoll.se',
  'guide.mrkoll.step1': 'Gå till länken ovan',
  'guide.mrkoll.step2': 'Fyll i dina uppgifter och klicka på "Skicka"',
  'guide.hitta.title': 'Hitta.se',
  'guide.hitta.step1': 'Gå till länken ovan',
  'guide.hitta.step2': 'Fyll i dina uppgifter och klicka på "Skicka"',
  'guide.merinfo.title': 'Merinfo.se',
  'guide.merinfo.step1': 'Fyll i dina uppgifter och klicka på "Skicka"',
  'guide.ratsit.title': 'Ratsit.se',
  'guide.ratsit.step1': 'Gå till länken ovan',
  'guide.ratsit.step2': 'Fyll i dina uppgifter och klicka på "Skicka"',
  'guide.birthday.title': 'Birthday.se',
  'guide.birthday.step1': 'Gå till länken ovan och klicka på "Kontakta oss"',
  'guide.birthday.step2': 'Skicka ett mail med meddelandet: "Hej, jag vill bli borttagen från er sida. Mvh"',
  'guide.upplysning.title': 'Upplysning.se',
  'guide.upplysning.step1': 'Gå till länken ovan och klicka på "Kontakta oss"',
  'guide.upplysning.step2': 'Skicka ett mail med meddelandet: "Hej, jag vill bli borttagen från er sida. Mvh"',
