...
export const ScoreVisual = ({ language }: ScoreVisualProps) => {
  ...
  return (
    <div className="flex flex-col items-start gap-6 w-full bg-white dark:bg-[#1c1c1e] p-4 md:p-6 rounded-2xl shadow-sm border border-[#e5e7eb] dark:border-[#232325] transition-colors duration-200">
      {/* Score number */}
