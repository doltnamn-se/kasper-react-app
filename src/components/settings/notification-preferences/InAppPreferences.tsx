  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <Switch
        checked={true}
        disabled={true}
        className="data-[state=checked]:bg-[#121212] dark:data-[state=checked]:bg-[#FFFFFF] [&_span[data-state=checked]]:bg-white dark:[&_span[data-state=checked]]:bg-[#1c1c1e] cursor-not-allowed"
      />
    </div>
  );
};
