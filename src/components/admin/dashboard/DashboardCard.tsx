...
export const DashboardCard = ({ 
  ...
  return (
    <div className="bg-white dark:bg-[#1c1c1e] p-6 rounded-2xl shadow-sm dark:border dark:border-[#232325] transition-colors duration-200 flex flex-col h-full overflow-hidden">
