              ...
              <div className="flex items-end h-full">
                <CollapsibleTrigger asChild>
                  <Button
                    size="sm"
                    variant="outline"
                    className="h-8 text-[0.8rem] font-medium text-[#121212] dark:text-[#ffffff] px-3 bg-transparent border border-[#dfdfdf] dark:border-[#2e2e2e] hover:bg-[#f3f3f3] dark:hover:bg-[#212121] rounded-full"
                  >
