    ...
    <div className="w-full">
      ...
      <div className="relative">
        <Progress 
          ...
          className="h-3 rounded-full overflow-hidden mb-4 bg-[#e8e8e5] dark:bg-[#2f2e31]"
        ...
        >
          <div className="w-6 h-6 rounded-full bg-[#000000] dark:bg-[#FFFFFF] border-4 border-white dark:border-[#222224] shadow-[0_0_15px_rgba(0,0,0,0.25)] dark:shadow-[0_0_15px_rgba(34,34,36,0.25)]"></div>
        </div>
      </div>
