  ...
  const renderNavLink = (path: string, icon: React.ReactNode, label: string, unreadCount: number = 0) => {
    ...
    return (
      ...
      >
        ...
        {hasNotification && (
          <div className="flex items-center justify-center h-5 px-2.5 rounded-full bg-[#000000] dark:bg-[#FFFFFF] text-white dark:text-black text-xs font-medium -mt-[0.5px]">
