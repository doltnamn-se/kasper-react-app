...
export const SidebarFooter = () => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 px-6 py-4 flex justify-between items-center bg-white dark:bg-[#1c1c1e] border-t border-[#e5e7eb] dark:border-[#232325]">
      <LanguageSwitch />
