    ...
    <a href="https://joinkasper.com/" className="inline-block mb-6">
      <div className="relative h-6 w-auto mr-auto -ml-[5px] min-w-[100px]">
        <img
          ...
          alt="Logo"
          className={`h-6 w-auto transition-opacity duration-200 pointer-events-none ${isDarkMode ? 'opacity-100' : 'opacity-0'}`}
        ...
        <img
          ...
          alt="Logo"
          className={`h-6 w-auto transition-opacity duration-200 pointer-events-none ${isDarkMode ? 'opacity-0' : 'opacity-100'}`}
          style={{ position: 'absolute', top: 0, left: '50%', transform: 'translateX(-50%)' }}
          draggable="false"
          onContextMenu={(e) => e.preventDefault()}
