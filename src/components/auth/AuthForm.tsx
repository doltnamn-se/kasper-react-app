...
export const AuthForm = ({ 
  ...
  return (
    <div className="flex justify-center w-full">
      <div className="bg-white/30 dark:bg-[#232325]/30 backdrop-blur-md p-8 border border-white/20 dark:border-[#303032]/20 w-full max-w-sm fade-in rounded-[7px] font-system-ui shadow-xl">
